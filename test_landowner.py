...
class Test_landowner(unittest.TestCase):
    def setUp(self):
        ...
        self.landowner = Landowner(money=200000, income=5000, patience=12, type="Agg")
    ...
    def test_calculate_monthly_mortgage_payment(self):
        """Test the mortgage payment calculation."""
        loan_amount = 80000
        rate = 0.05
        term = 360
    ...
    def test_collect_rent(self):
        """Test that a landowner can collect rent from buildings."""
        unit1 = Unit(1000, True, 12)
        unit2 = Unit(1500, True, 12)
    ...
    def test_pay_mortgage(self):
        """Test that a landowner can pay mortgage costs."""
        self.landowner.acquire_building(self.building1)
        initial_money = self.landowner.money
    ...
    def test_sell_building(self):
        """Test that a landowner can sell a building."""
        self.landowner.acquire_building(self.building1)
        initial_money = self.landowner.money
    ...
    def test_redevelop_building(self):
        """Test that a landowner can redevelop a building."""
        self.landowner.acquire_building(self.building1)
        initial_money = self.landowner.money
    ...
    def test_make_decision_aggressive(self):
        """Test decision making for aggressive landowner."""
    ...
    def test_make_decision_passive(self):
        """Test decision making for passive landowner."""
        self.landowner.type = "Pass"
        self.building1.age = 25
